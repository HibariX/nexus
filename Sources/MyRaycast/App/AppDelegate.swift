...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func importRectangle() -> String? {
        ...
        alert.informativeText = "\(imported.summary)\n\n确认后会覆盖 MyRaycast 的窗口快捷键，将 Rectangle 的待办快捷键迁移到「今日待办」，关闭 Rectangle 的登录启动偏好并退出正在运行的 Rectangle。不会卸载 Rectangle。"
        ...
        return "\(imported.summary) 正在切换到 MyRaycast 快捷键；Rectangle 已请求退出。若“登录项”仍显示 Rectangle，请在系统设置中手动关闭。"
    }
